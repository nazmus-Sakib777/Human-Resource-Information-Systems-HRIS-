...
{
    /// <inheritdoc />
    public partial class SeedInitialDataNkB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            columns: new[]
            {
                "HoliDayBillRateID", "SerialNumber", "SalaryMinimum", "SalaryMaximum", "HoliDayBillRateValue", "EmployeeID"
            },
            values: new object[,]
            {
                {
                    "HBR001", 1, 15000.00m, 25000.00m, 1200, "E001"
                },
                {
                    "HBR002", 2, 25001.00m, 35000.00m, 1500, "E002"
                },
                {
                    "HBR003", 3, 35001.00m, 50000.00m, 1800, "E003"
                },
                {
                    "HBR004", 4, 35001.00m, 50000.00m, 1800, "E004"
                },
                {
                    "HBR005", 5, 35001.00m, 50000.00m, 1800, "E005"
                }
            });
            ...
            columns: new[]
            {
                "HoliDayEntitledEmployeeID", "AttendanceDate", "AttendanceStatus", "LocalAreaClerance",
                "LocalAreaRemarks", "ApprovedDate", "EntryUser", "EmployeeID"
            },
            values: new object[,]
            {
                {
                    "HEE001", DateTime.Parse("2025-05-01"), "Present", "Cleared", "No remarks",
                    DateTime.Parse("2025-05-02"), "admin", "E001"
                },
                {
                    "HEE002", DateTime.Parse("2025-05-01"), "Absent", "Pending", "Needs verification",
                    DateTime.Parse("2025-05-03"), "admin", "E002"
                },
                {
                    "HEE003", DateTime.Parse("2025-05-01"), "Leave", "Cleared", "Medical leave",
                    DateTime.Parse("2025-05-02"), "admin", "E003"
                },
                {
                    "HEE004", DateTime.Parse("2025-05-01"), "Leave", "Cleared", "Entitled leave",
                    DateTime.Parse("2025-05-02"), "admin", "E004"
                },
                {
                    "HEE005", DateTime.Parse("2025-05-01"), "Leave", "Cleared", "Sick leave",
                    DateTime.Parse("2025-05-02"), "admin", "E005"
                }
            });
            ...
            columns: new[]
            {
                "HoliDayInformationID", "FromDate", "EndDate", "EventType", "EventName",
                "Remarks", "EntryUser", "EmployeeID"
            },
            values: new object[,]
            {
                {
                    "HDI001", DateTime.Parse("2025-05-01"), DateTime.Parse("2025-05-01"), "Public", "May Day",
                    "International Workers' Day", "admin", "E001"
                },
                {
                    "HDI002", DateTime.Parse("2025-05-15"), DateTime.Parse("2025-05-15"), "Religious", "Buddha Purnima",
                    "National holiday", "admin", "E002"
                },
                {
                    "HDI003", DateTime.Parse("2025-06-17"), DateTime.Parse("2025-06-19"), "Religious", "Eid-ul-Adha",
                    "Three-day religious holiday", "admin", "E003"
                },
                {
                    "HDI004", DateTime.Parse("2025-06-17"), DateTime.Parse("2025-06-19"), "Religious", "Eid-ul-Fitr",
                    "Three-day religious holiday", "admin", "E004"
                },
                {
                    "HDI005", DateTime.Parse("2025-06-17"), DateTime.Parse("2025-06-19"), "Religious", "Eid-ul-Adha",
                    "Three-day religious holiday", "admin", "E005"
                }
            });
            ...
            columns: new[]
            {
                "BonusRecordID", "BonusDate", "JoiningDate", "BasicSalary", "HouseRent",
                "MedicalAllowance", "ConveyanceAllowance", "OtherAllowance", "GrossSalary",
                "BonusPercent", "BonusAmount", "FestivalName", "RevenueStampAmount",
                "NetPayableAmount", "EmployeeID"
            },
            values: new object[,]
            {
                {
                    "BR001", DateTime.Parse("2025-04-10"), DateTime.Parse("2024-01-15"), 20000m, 10000m,
                    3000m, "2000", "1000", 36000m, 50m, 18000m, "Eid-ul-Fitr", 100m, 17900m, "E001"
                },
                {
                    "BR002", DateTime.Parse("2025-04-10"), DateTime.Parse("2023-03-01"), 22000m, 11000m,
                    3500m, "1800", "1200", 39500m, 60m, 23700m, "Eid-ul-Fitr", 100m, 23600m, "E002"
                },
                {
                    "BR003", DateTime.Parse("2025-04-10"), DateTime.Parse("2022-12-05"), 18000m, 9000m,
                    2500m, "1500", "800", 32300m, 45m, 14535m, "Eid-ul-Fitr", 100m, 14435m, "E003"
                }
            });
            ...
            columns: new[]
            {
                "EntryNumber", "EmployeeID", "EntryType", "EntryDate", "Description"
            },
            values: new object[,]
            {
                {
                    "CH001", "E001", "Promotion", DateTime.Parse("2023-06-01"), "Promoted from Junior Officer to Officer"
                },
                {
                    "CH002", "E002", "Transfer", DateTime.Parse("2024-02-15"), "Transferred from Unit A to Unit B"
                },
                {
                    "CH003", "E003", "Increment", DateTime.Parse("2025-01-01"), "Annual salary increment approved"
                },
                {
                    "CH004", "E004", "Award", DateTime.Parse("2023-12-20"), "Received Best Employee of the Year award"
                },
                {
                    "CH005", "E005", "Training", DateTime.Parse("2024-09-10"), "Completed leadership training program"
                }
            });
            ...
            columns: new[]
            {
                "ContactID", "Name", "Occupation", "Relation", "Address", "Phone", "EmployeeID", "Flag"
            },
            values: new object[,]
            {
                {
                    "CP001", "Ayesha Karim", "Teacher", "Mother", "123 Gulshan Ave, Dhaka", "01711001100", "E001", "RED"
                },
                {
                    "CP002", "Rahim Uddin", "Businessman", "Father", "45 Motijheel, Dhaka", "01722002200", "E002", "RED"
                },
                {
                    "CP003", "Tania Sultana", "Engineer", "Spouse", "12 Banani, Dhaka", "01733003300", "E003", "BLUE"
                },
                {
                    "CP004", "Shamim Alam", "Doctor", "Brother", "67 Dhanmondi, Dhaka", "01744004400", "E004", "BLUE"
                },
                {
                    "CP005", "Fatema Khatun", "Homemaker", "Mother", "23 Uttara, Dhaka", "01755005500", "E005", "TAN"
                }
            });
            ...
            columns: new[]
            {
                "ActionID", "EmployeeID", "ActionType", "ActionDate", "Description", "ActionStatus"
            },
            values: new object[,]
            {
                {
                    "DA001", "E001", "Late Attendance", DateTime.Parse("2024-11-10"), "Employee repeatedly arrived late without justification.", "Warning"
                },
                {
                    "DA002", "E002", "Misconduct", DateTime.Parse("2025-01-22"), "Involved in verbal conflict with colleague.", "Investigated"
                },
                {
                    "DA003", "E003", "Policy Violation", DateTime.Parse("2024-09-15"), "Used office equipment for personal use.", "Resolved"
                },
                {
                    "DA004", "E004", "Absenteeism", DateTime.Parse("2025-02-10"), "Absent without notice for 3 consecutive days.", "Suspended"
                },
                {
                    "DA005", "E005", "Negligence", DateTime.Parse("2025-03-05"), "Failed to complete critical assignment on time.", "Final Warning"
                }
            });
            //migrationBuilder.InsertData(
            ...
            //{
            //    {
            //        "EL001", DateTime.Parse("2025-05-10"), "Medical", TimeSpan.Parse("14:30"), "E001"
            //    },
            //    {
            //        "EL002", DateTime.Parse("2025-05-12"), "Personal", TimeSpan.Parse("15:00"), "E002"
            //    },
            //    {
            //        "EL003", DateTime.Parse("2025-05-15"), "Family Emergency", TimeSpan.Parse("13:15"), "E003"
            //    },
            //    {
            //        "EL004", DateTime.Parse("2025-05-18"), "Urgent Work", TimeSpan.Parse("12:45"), "E004"
            //    },
            //    {
            //        "EL005", DateTime.Parse("2025-05-20"), "Appointment", TimeSpan.Parse("16:00"), "E005"
            //    }
            //});
    ...
    columns: new[]
    {
        "BenefitID", "EmployeeID", "BenefitDate", "BenefitAmount", "BenefitType", "BenefitActivationDate",
        "PreviousNetSalary", "NewNetSalary", "SalaryStepID", "GradeID", "GrossSalary", "BasicSalary",
        "HouseRent", "MedicalAllowance", "ConveyanceAllowance", "LunchAllowance", "OtherAllowance",
        "SalaryRecordID", "CashIncentive", "LocalAreaClerance", "LocalAreaRemarks", "ApprovalDate",
        "EntryUser", "SalaryGradeID"
    },
    values: new object[,]
    {
        {
            "BEN001", "E001", DateTime.Parse("2025-01-15"), 15000.00m, "Annual Increment", DateTime.Parse("2025-02-01"),
            45000.00m, 60000.00m, "SS01", "GRD001", 60000.00m, 30000.00m,
            15000.00m, 5000.00m, 2000.00m, 1500.00m, 1000.00m,
            "SR001", 3000.00m, "Cleared", "Meets all local area criteria.", DateTime.Parse("2025-02-05"),
            "admin", "SG001"
        },
        {
            "BEN002", "E002", DateTime.Parse("2025-01-20"), 10000.00m, "Promotion", DateTime.Parse("2025-02-10"),
            35000.00m, 50000.00m, "SS02", "GRD002", 50000.00m, 25000.00m,
            12000.00m, 4000.00m, 1500.00m, 1000.00m, 500.00m,
            "SR002", 2000.00m, "Cleared", "Transferred to new department.", DateTime.Parse("2025-02-15"),
            "hruser", "SG002"
        },
        {
            "BEN003", "E003", DateTime.Parse("2025-02-01"), 8000.00m, "Adjustment", DateTime.Parse("2025-03-01"),
            40000.00m, 48000.00m, "SS03", "GRD003", 48000.00m, 24000.00m,
            12000.00m, 4000.00m, 1500.00m, 800.00m, 700.00m,
            "SR003", 1500.00m, "Cleared", "Salary adjusted due to overtime.", DateTime.Parse("2025-03-10"),
            "finance1", "SG003"
        },
        {
            "BEN004", "E004", DateTime.Parse("2025-02-10"), 12000.00m, "Annual Increment", DateTime.Parse("2025-03-05"),
            50000.00m, 62000.00m, "SS04", "GRD004", 62000.00m, 31000.00m,
            15000.00m, 5000.00m, 2000.00m, 1500.00m, 1500.00m,
            "SR004", 2500.00m, "Cleared", "Met KPIs and performance targets.", DateTime.Parse("2025-03-15"),
            "admin", "SG004"
        },
        {
            "BEN005", "E005", DateTime.Parse("2025-02-15"), 9000.00m, "Adjustment", DateTime.Parse("2025-03-10"),
            42000.00m, 51000.00m, "SS05", "GRD005", 51000.00m, 25500.00m,
            12750.00m, 4250.00m, 1750.00m, 1125.00m, 625.00m,
            "SR005", 1800.00m, "Cleared", "New project assignment bonus.", DateTime.Parse("2025-03-20"),
            "hradmin", "SG005"
        }
    });
